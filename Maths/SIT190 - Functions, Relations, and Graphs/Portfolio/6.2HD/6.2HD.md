...
"Look out for lines of the form ax + by = c in Task 1.2."
$x= -1$
$y= 2$
$z= 0$
...
$2\sin\left(2(\pi)+ \frac{\pi}{4}\right)= \sqrt{2}$
$2\sin\left(2(-\pi)+ \frac{\pi}{4}\right)= \sqrt{2}$
$2\sin\left(2( \frac{\pi}{4} )+ \frac{\pi}{4}\right)= \sqrt{2}$
$2\sin\left(2( \frac{2\pi}{4} )+ \frac{\pi}{4}\right)= -\sqrt{2}$
$2\sin\left(2( \frac{-2\pi}{4} )+ \frac{\pi}{4}\right)= -\sqrt{2}$
$2\sin\left(2( \frac{-3\pi}{4} )+ \frac{\pi}{4}\right)= \sqrt{2}$
$2\sin\left(2( \frac{2\pi}{4} )+ \frac{\pi}{4}\right)= -\sqrt{2}$

$(\pi, \sqrt{2}), (-\pi, \sqrt{2}), (\frac{\pi}{4}, \sqrt{2}), (\frac{-3\pi}{4}, \sqrt{2})$

$x$ values = $\pi, -\pi, \frac{\pi}{4}, \frac{-3\pi}{4}, 0$ radians
...
$x^{+} = \arccos\left( \frac{-1}{\sqrt{2}} \right)\approx 2.356$
$x^{-} = \arccos( \frac{-1}{-\sqrt{2}} )\approx 0.785$
